...
function setupFormEvents() {
  ...
  if (resetEstablishmentBtn && establishmentForm) {
    resetEstablishmentBtn.addEventListener("click", () => {
      establishmentForm.reset()
    })
  }
  ...
  if (searchEstablishmentBtn) {
    searchEstablishmentBtn.addEventListener("click", () => {
  ...
  if (modifyEstablishmentForm) {
    modifyEstablishmentForm.addEventListener("submit", (e) => {
      e.preventDefault()
  ...
  if (deleteEstablishmentForm) {
    deleteEstablishmentForm.addEventListener("submit", (e) => {
      e.preventDefault()
  ...
  if (resetDelEstablishmentBtn && deleteEstablishmentForm) {
    resetDelEstablishmentBtn.addEventListener("click", () => {
      deleteEstablishmentForm.reset()
    })
  }
  ...
  if (resetDelUserBtn && deleteUserForm) {
    resetDelUserBtn.addEventListener("click", () => {
      deleteUserForm.reset()
    })
  }
  ...
  if (searchActaBtn) {
    searchActaBtn.addEventListener("click", () => {
  ...
  if (actaForm) {
    actaForm.addEventListener("submit", (e) => {
      ...
      const newActa = {
        id: Date.now(),
        num_acta: Number.parseInt(document.getElementById("acta-num").value),
        tema: "Informática",
...
// Eliminar la función dummy toggleTheme

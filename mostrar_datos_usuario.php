            ...
            <section>
                ...
                <form class="md"action="mostrar_usuario.php" method="post">
                    ...
                    <div class="sec-titles text-center wow animated fadeInDown">
                            <h2>Muestra de Usuarios:</h2>
                            <p>Muestra de Datos que se encuentran en Los Usuarios</p>
                            <br>
                        </div>
                ...
                <div class="sec-titles text-center wow animated fadeInDown">
                <p>Para ver Los datos del establecimiento y Actas </p>
                            <p>clique aqui </p>
                        </div>
                <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    <li class="page-item disabled">
                    <a class="page-link" href="mostrar_datos.php" tabindex="-1">Atras</a>
                    </li>
                        ...
                        <li class="page-item">
                        <a class="page-link" href="mostrar_datos_acta.php">Siguiente</a>
                    </li>
                 </ul>
            </nav>
                </form>

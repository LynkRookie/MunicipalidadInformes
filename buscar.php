...
<html lang="es" class="no-js">
	<head>
		...
		<meta charset="utf-8">
			...
			<!-- Main Stylesheet -->
			<link rel="stylesheet" href="css/css_informe/estilo_informes.css">
			<!-- Main Stylesheet -->
			...
			<div class="overlay">
				<div class="container">
					<div class="row">
						...
						<form class="formauno-1"action="buscar.php" method="post">
							<div class="table-responsive">
								<table class="table table-bordered">
									...
									<div class="formados">
										...
										<label class="fecha">fecha:<input class="fecha"type="date" name="fecha" value="<?php echo date('Y-m-d'); ?>" ></label>
										<br>
									</div>
									<br>
									
										<label>Buscar Por Rbd:</label>
										...
										<tbody>
											...
											if(empty($rbd_b) ){
												...
												while($row=mysqli_fetch_assoc($resultado)){
													...
													/*
												echo '<div class="btn-bg bg-1">';
														echo '<div class="btn btn-1"><a class="h-button centered">';
														echo '<button  type="submit" data-hover="Descargar" name="registro_acta"><div>Registrar</div></button></a>';
														echo '<i class="fa-regular fa-cloud-arrow-down fa-bounce fa-xs" style="color: #ffffff;"></i>';
														echo '</div>';
													echo '</div>';
													y
